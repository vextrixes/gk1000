...
impl RGBController {
    ...
    fn uk(&mut self) -> Result<(), HidWrapperError> { //TODO: Rename func and possibly change packets depending on mode
        self.hid_wrapper.send_report(&[
    ...
    pub fn set_color(&mut self, red: u8, green: u8, blue: u8) -> Result<(), HidWrapperError> { //TODO: effect specific functions
        ...
        let kmp: [[u8; 3]; 144] = [[0, 0, 0]; 144];
        self.custom_keys(&kmp)?;
